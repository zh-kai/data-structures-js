...
import { LinkedList, LinkedListNode } from "../src/linkedList/linkedList";
...
describe('✨ LinkedList unit tests', () => {
  ...
  describe('.forEach(cb)', () => {
    ...
    it('throws an error if cb is not a function', () => {
      expect(() => linkedList.forEach('test')).to.throw(Error)
        .and.to.have.property('message', 'forEach argument expect a function');
    });
  });
  ...
  describe('.find(cb)', () => {
    ...
    it('throws an error if cb is not a function', () => {
      expect(() => linkedList.find('test')).to.throw(Error)
        .and.to.have.property('message', 'find argument expect a function');
    });
  });
  ...
  describe('.filter(cb)', () => {
    ...
    it('throws an error if cb is not a function', () => {
      expect(() => linkedList.filter('test')).throw(Error).property('message', 'filter argument expect a function');
    });
  });
  ...
  describe('.removeEach(cb)', () => {
    ...
    it('throws an error if cb is not a function', () => {
      expect(() => linkedList.removeEach('test')).to.throw(Error)
        .and.to.have.property('message', 'removeEach argument expect a function');
    });
  });
